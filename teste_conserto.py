...
PERGUNTA_CONSERTO= "audios\\uso conserto.wav"

class TestePerguntaConserto(unittest.TestCase):
    ...
    def testar_uso_crase(self):
        ...
        tem_fala, fala = processar_audio_da_fala(PERGUNTA_CONSERTO, reconhecedor)
...
if __name__ == "__main__":
    ...
    testes.addTest(carregador.loadTestsFromTestCase(TestePerguntaConserto))
