...
PERGUNTA_CRASE = "audios\\uso crase.wav"

class TestePerguntaCrase(unittest.TestCase):
    ...
    def testar_uso_crase(self):
        ...
        tem_fala, fala = processar_audio_da_fala(PERGUNTA_CRASE, reconhecedor)
...
if __name__ == "__main__":
    ...
    testes.addTest(carregador.loadTestsFromTestCase(TestePerguntaCrase))
